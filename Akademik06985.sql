...
MySQL - 10.4.32-MariaDB : Database - pwlgenap2019-akademik
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pwlgenap2019-akademik` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
(3,'CS JGRP.jpg','uploads/resized_CS JGRP.jpg'),
(4,'Gambar anime 1.png','uploads/resized_Gambar anime 1.png');
...
/*Data for the table `gambar_thumbnail` */

insert  into `gambar_thumbnail`(`id`,`filename`,`filepath`,`thumbpath`,`width`,`height`,`uploaded_at`) values 
(1,'Gambar anime 1.png','uploads/Gambar anime 1.png','thumbs/thumb_Gambar anime 1.png',712,1000,'2025-04-13 12:13:46'),
(2,'CS JGRP.jpg','uploads/CS JGRP.jpg','thumbs/thumb_CS JGRP.jpg',800,656,'2025-04-13 12:15:03');
...
(44,'A12.2016.02890','Dwiky Adi','dwiky@gmail.com','1692004782752.png'),
(45,'A12.2023.06985','Dwiky Adi','dwiky@gmail.com','1692004765772.png');
...
(1,'admin','passwordbaru','admin'),
(2,'mhs','passwordbaru','mhs'),
(3,'dsn','passwordbaru','dsn'),
(4,'tu','passwordbaru','tu'),
(5,'llg','passwordbaru','admin'),
(7,'A12.2016.02898','passwordbaru','mhs'),
(13,'Blazeenzy','cek123','mhs');
